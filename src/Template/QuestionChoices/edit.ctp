    ...
    <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--8-col-tablet">
        <div class="mdl-card session-list-card mdl-shadow--2dp" style="overflow-y : auto; height : 650px;">
            <div class="mdl-card__actions mdl-card--border">
                <h4 class="profil-list-titre">Editer une question d'un QCM</h4>
            </div>
            ...
            <fieldset style="padding :30px;">
                <?php
                    ...
                    echo '<br />';
                    echo '<br />';
                    echo $this->Form->control('answerId', array('type'=>'Réponse','options'=>$answers, 'class' => 'mdl-selectfield__select'));
                    echo '<br />';
                    echo '<br />';
                    echo $this->Form->control('userId', array('type'=>'Utilisateur','options'=>$users, 'class' => 'mdl-selectfield__select'));
                    echo '<br />';
                    echo '<br />';
                ?>
            </fieldset>
